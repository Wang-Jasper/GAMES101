...
/// @brief Assigns a 3D position to the specified vertex
/// @param ind Index of the vertex
/// @param ver The 3D coordinate
...
/// @brief Convert 3D vector to homogeneous coordinates
/// @return std::array<Vector4f, 3> Array of three 4D homogeneous vertices
